...
const createService = require('./src/controllers/service/createService');
const findService = require('./src/controllers/service/findService');
...
app.get('/api/services', findService);
